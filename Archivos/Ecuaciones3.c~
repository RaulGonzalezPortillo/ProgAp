  ...
  if (Archivo != NULL)
    {
      ...
      do
	{
	  printf ("El archivo ya existe. Puedes (s)obreescribir, (a)nhiadir (t)erminar: ");
	  scanf (" %c", &Opcion);
	  switch (Opcion)
	    {
	    case 'S' : case 's' :
...
void PedirEcuaciones (int MatrizCoef [3] [5])
{
  ...
  printf ("En cada renglon escribe los valores de los coeficients de acuerdo al siguiente formato: a, b, c\n");
  for (i = 0; i < 5; i ++)
